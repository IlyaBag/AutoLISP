...
'((-1 . <Имя объекта: 186654c20c0>) (0 . MULTILEADER) (330 . <Имя объекта: 1866333c700>) (5 . 4BC) (100 . AcDbEntity) (67 . 0) (410 . Model) (8 . 0) (100 . AcDbMLeader) (270 . 2)
  (300 . CONTEXT_DATA{) (40 . 1.0) (10 3156.36 -37.0 0.0) (41 . 3.5) (140 . 3.0) (145 . 0.09) (174 . 1) (175 . 6) (176 . 0) (177 . 0) (290 . 1) (304 . лор) (11 0.0 0.0 1.0)
  (340 . <Имя объекта: 1866333c550>) (12 3156.45 -35.25 0.0) (13 1.0 0.0 0.0) (42 . 0.0) (43 . 0.0) (44 . 0.0) (45 . 1.0) (170 . 1) (90 . -1073741824) (171 . 1) (172 . 5) (91 . -1073741824)
  (141 . 0.0) (92 . 0) (291 . 0) (292 . 0) (173 . 0) (293 . 0) (142 . 0.0) (143 . 0.0) (294 . 0) (295 . 0) (296 . 0) (110 3145.0 -53.0 0.0) (111 1.0 0.0 0.0) (112 0.0 1.0 0.0) (297 . 0)
  (302 . LEADER{) (290 . 1) (291 . 1) (10 3156.0 -37.0 0.0) (11 1.0 0.0 0.0) (90 . 0) (40 . 0.36) (304 . LEADER_LINE{) (10 3145.0 -53.0 0.0) (91 . 0) (170 . 1) (92 . -1056964608)
  (340 . <Имя объекта: 0>) (171 . -2) (40 . 0.0) (341 . <Имя объекта: 0>) (93 . 0) (305 . }) (271 . 0) (303 . }) (272 . 9) (273 . 9) (301 . })
  (340 . <Имя объекта: 1866333c670>) (90 . 345600) (170 . 1) (91 . -1056964608) (341 . <Имя объекта: 1866333c5b0>) (171 . -2) (290 . 1) (291 . 1) (41 . 0.36) (42 . 3.0) (172 . 2)
  (343 . <Имя объекта: 1866333c550>) (173 . 1) (95 . 6) (174 . 1) (175 . 0) (92 . -1056964608) (292 . 0) (93 . -1056964608) (10 1.0 1.0 1.0) (43 . 0.0) (176 . 0) (293 . 0) (294 . 0)
  (178 . 0) (179 . 1) (45 . 1.0) (271 . 0) (272 . 9) (273 . 9) (295 . 1)
 )
...
;;;  число на заданную величину, после чего обновляет объект.
  (setq props      (entget ent)
        enttype    (cdr (assoc 0 props))          ; тип выбранного объекта
        entcontdxf (cdr (assoc enttype DXFcodes)) ; dxf код содержания выбранного объекта
        entcont    (cdr (assoc entcontdxf props)) ; содержание выбранного объекта
  ) ;_ end setq
  (setq props (subst (cons entcontdxf (itoa (+ (atoi entcont) inc)))
                     (assoc entcontdxf props)
                     props
              ) ;_ end subst
  ) ;_ end setq
  (entmod props)
...
(defun BG:osnaps-enable (old_osm)
;;;  Получает числовое значение режима привязки (значение системной переменной OSMODE)
;;;  и активирует режим привязки если он был отключен.
  (if (> old_osm 16384)
    (setvar "osmode" (- old_osm 16384))
  ) ;_ end if
) ;_ end defun
...
(defun BG:mleader-increment-kludge (ent inc / props entcont osm old_dxf_10 old_dxf_12 new_dxf_10 new_dxf_12)
  ...
  (if (= (cdr (assoc 0 props)) "MULTILEADER")
    (progn
      ...
      (setq osm (BG:osnaps-disable))
      (command "_MOVE" ent "" '(0 0) '(1 0)
               "_MOVE" ent "" '(0 0) '(-1 0)
      ) ;_ end command
      (BG:osnaps-enable osm)
